...
# 1. Define the sigmoid function: This function maps input values to a probability between 0 and 1.
# 2. Compute the cost function: This calculates the logistic loss (cross-entropy) between the predicted and true labels.
# 3. Perform gradient descent: This algorithm iteratively updates the model parameters (theta) to minimize the cost function.
# 4. Logistic Regression function: This function initializes the parameters and runs gradient descent to optimize them.
# 5. Example usage:
#    - X: Feature matrix (with an intercept term). Example: X = [[1, 1], [1, 2], [1, 3], [1, 4], [1, 5]]
