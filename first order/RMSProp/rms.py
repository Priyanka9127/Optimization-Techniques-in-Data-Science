# This script implements the RMSProp optimizer for the Rosenbrock function optimization.
# The RMSProp optimizer adapts the learning rate based on past gradients using a moving average of squared gradients.
# The optimizer includes enhanced stopping criteria, such as convergence due to small gradients or small parameter changes.
# The Rosenbrock function is used as a test function, and its gradient is calculated for optimization.
# The optimization path is visualized using 2D and 3D plots.
# Animation is created to visualize the optimizer's progress over iterations.
